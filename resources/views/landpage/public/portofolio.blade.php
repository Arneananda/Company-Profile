...
<body>
    ...
    <!-- Header End -->
    <!-- home Section Start -->
      <section id="Portofolio" class=" pt-36 pb-20  bg-dark">
                <div class="flex w-full flex-wrap justify-center gap-6 md:gap-1 lg:gap-10 px-4 xl:mx-auto xl:w-full">
                    <div class="mb-2   h-full bg-birutua rounded-lg  md:h-full lg::w-1/2">
                        <div class="overflow-hidden rounded-md shadow-md">
                            <img class="w-64 h-48 md:w-[565px] md:h-[423.52px]" src="{{ asset('storage/' . $porto->cover) }}" alt="Landing Page" width="w-full" />
                        </div>
                    </div>
                    <div class="w-[260px] md:w-[565px] h-full p-5 md:p-[26px] bg-slate-900 rounded-xl flex-col justify-start items-start gap-2.5 inline-flex">
    <div class="self-stretch text-white text-base md:text-[22px] font-semibold ">{{ $porto->project_name }}</div>
    <div class="self-stretch justify-between items-start inline-flex">
        <div class="w-[86px] md:w-[226px] text-white text-sm font-medium ">Client</div>
        <div class="grow shrink basis-0 text-white text-sm font-medium ">{{ $porto->client }}</div>
    </div>
    <div class="self-stretch justify-start items-start inline-flex">
        <div class="w-[86px] md:w-[226px] text-white text-sm font-medium ">Service</div>
        <div class="grow shrink basis-0 text-white text-sm font-medium ">{{ $porto->service }}</div>
    </div>
    <div class="self-stretch justify-start items-start inline-flex">
        <div class="w-[86px] md:w-[226px] text-white text-sm font-medium ">Start Date</div>
        <div class="grow shrink basis-0 text-white text-sm font-medium ">{{ $porto->waktu_mulai }}</div>
    </div>
    <div class="self-stretch justify-start items-start inline-flex">
        <div class="w-[86px] md:w-[226px] text-white text-sm font-medium ">End Date</div>
        <div class="grow shrink basis-0 text-white text-sm font-medium ">{{ $porto->waktu_selesai }}</div>
    </div>
    <div class="self-stretch justify-start items-start inline-flex">
        <div class="w-[86px] md:w-[226px] text-white text-sm font-medium ">Description</div>
        <div class="grow shrink basis-0 text-white text-sm font-medium ">{{ $porto->description }}</div>
    </div>
</div>
                </div>
                </section>
